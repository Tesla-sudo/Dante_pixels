...
import { Check, Camera, Sparkles, Frame, Clock, Users, Star  } from "lucide-react";
import heroImage from "../assets/done5.jpg";
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service, i) => (
              ...
              >
                ...
                <a
                  href={`https://wa.me/254707888778?text=Hi! I'd like to book *${encodeURIComponent(
                    service.title
      ...
      <section className="py-20 bg-gradient-to-r from-yellow-400 to-orange-500 text-black">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/254707888778?text=Hi! I saw your services and want to book a shoot."
              target="_blank"
              rel="noopener noreferrer"
