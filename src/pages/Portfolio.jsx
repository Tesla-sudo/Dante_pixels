...
import done18 from "../assets/done18.jpg";
import done19 from "../assets/done19.jpg";
export default function Portfolio() {
  ...
  const portfolioItems = [
    ...
    { id: 18, src: done18, title: ""},
    { id: 19, src: done19, title: ""},
      ...
      <section className="py-20 bg-gradient-to-r from-yellow-400 to-orange-500 text-black">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-black text-white px-10 py-3 rounded-full text-lg font-bold hover:bg-gray-900 transition shadow-lg"
          >
            Follow @donepictures
          </a>
        </motion.div>
