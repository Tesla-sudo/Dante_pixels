...
export default function Navbar() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <ul className="hidden md:flex items-center gap-8">
              ...
              <li>
                <a
                  href="https://wa.me/254707888778?text=Hi! I'd love to book a shoot."
                  target="_blank"
      ...
      <motion.a
        href="https://wa.me/254707888778?text=Hi! I'd love to book a shoot or get a quote."
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-40 bg-green-500 text-white p-4 rounded-full shadow-2xl hover:bg-green-600 transition transform hover:scale-110"
